...
interface IRegistrationContext {
	 ...
	 * @psalm-param class-string<\OCP\EventDispatcher\IEventListener<T>>|class-string<\OCP\EventDispatcher\Event> $listener fully qualified class name that can be built by the DI container
